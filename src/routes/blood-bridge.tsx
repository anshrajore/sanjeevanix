...
export const Route = createFileRoute("/blood-bridge")({
  head: () => ({
    meta: [
      { title: "Blood Bridge AI · Sanjeevani X" },
      {
        name: "description",
        content: "Enterprise architecture for AI-powered blood coordination.",
      },
    ],
  }),
  component: () => (
    <SubPage
      ...
      title={
        <>
          Enterprise <span className="text-gradient-red">Blood Coordination</span>
        </>
      }
      subtitle="From request to transfusion in under three minutes. Built on RAG memory, predictive scoring, and voice-native outreach."
    >
